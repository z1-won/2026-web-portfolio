...
const CONTENT_STYLE = {
  background: "linear-gradient(180deg, rgba(255,255,255,0.84), rgba(247,249,252,0.94))",
};
...
export default function SiteWindow({ children }: { children: React.ReactNode }) {
  ...
  if (isDesktopWindow || isMobile) {
    return (
      <div className="h-full overflow-y-auto" style={CONTENT_STYLE}>
        {children}
      </div>
    );
  }
